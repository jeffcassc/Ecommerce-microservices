...
class KafkaService:
    ...
    def create_topics():
        ...
        topic_list = [
            ...
            NewTopic(Config.CART_REMOVALS_TOPIC, num_partitions=3, replication_factor=1),
            NewTopic(Config.ORDER_CREATED_TOPIC, num_partitions=3, replication_factor=1),
            NewTopic(Config.INVOICE_PROCESSING_TOPIC, num_partitions=3, replication_factor=1)
        ]
