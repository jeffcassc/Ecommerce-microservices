...
class KafkaService:
    ...
    def create_topics():
        ...
        topic_list = [
            NewTopic(Config.PRODUCT_TOPIC, num_partitions=3, replication_factor=1),
            NewTopic(Config.CATEGORY_TOPIC, num_partitions=3, replication_factor=1),
            NewTopic(Config.INVENTORY_TOPIC, num_partitions=3, replication_factor=1)
        ]
